package com.kadirbekmn.survivorbird;
    ...
    public void render() {
        ...
        if (gameState == 1) {
            ...
            for (int i = 0; i < numberOfEnemies; i++) {
                ...
                enemyCircles1[i] = new Circle(enemyX[i] + Gdx.graphics.getWidth() / 30, Gdx.graphics.getHeight() / 2 + enemyOffSet1[i] + Gdx.graphics.getHeight() / 20, Gdx.graphics.getHeight() / 30);
...
//        shapeRenderer.circle(birdCircle.x, birdCircle.y, birdCircle.radius);
        ...
        for (int i = 0; i < numberOfEnemies; i++) {
//            shapeRenderer.circle(enemyX[i] + Gdx.graphics.getWidth() / 30, Gdx.graphics.getHeight() / 2 + enemyOffSet1[i] + Gdx.graphics.getHeight() / 20, Gdx.graphics.getHeight() / 30);
